...
gem 'foundation-rails', '~> 6.1.1', '>= 6.1.1.0'

gem 'jquery-rails', '~> 4.2', '>= 4.2.2'

# foundation form errors
gem 'foundation_rails_helper', '~> 3.0', '>= 3.0.0'
...
gem 'select2-rails', '~> 3.5', '>= 3.5.11' # newer breaks Foundation Reveal on tickets#show
